/* ============================================================
   ...
   3. Copy article-template.html into it as home.html
...
const KEY_RESIDUES = ["α-HisXXX", "β-CysXXX"]
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (featured) {
    featured.innerHTML = ARTICLES.filter((a) => a.featured)
      .map(renderFeatured)
      .join("")
  }
  ...
  if (cloud) {
    cloud.innerHTML = KEY_RESIDUES.map(
      (r) => `<span class="residue-pill">${r}</span>`,
    ).join(" ")
  }
})
