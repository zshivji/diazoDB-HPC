...
def test_public_contributors_returns_unique_orcids(client: TestClient, db: Session):
    db.add_all(
        [
            Contributor(orcid="0000-0000-0000-0002"),
            Contributor(orcid="0000-0000-0000-0001"),
        ]
    )
    db.commit()
